...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28948__auto__,writer__28949__auto__,opt__28950__auto__){
return cljs.core._write.call(null,writer__28949__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__30300 = o;
(G__30300[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__30301__delegate = function (args){
...
while (G__30302__i < G__30302__a.length) {G__30302__a[G__30302__i] = arguments[G__30302__i + 0]; ++G__30302__i;}
  args = new cljs.core.IndexedSeq(G__30302__a,0,null);
} 
return G__30301__delegate.call(this,args);};
G__30301.cljs$lang$maxFixedArity = 0;
G__30301.cljs$lang$applyTo = (function (arglist__30303){
var args = cljs.core.seq(arglist__30303);
return G__30301__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__28311__auto__ = !((jsprops == null));
if(and__28311__auto__){
var and__28311__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__30306 = jsprops;
(G__30306["defaultValue"] = value);

(G__30306["onChange"] = ((function (G__30306,v,value,on_change){
return (function (p1__30305_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30305_SHARP_);
});})(G__30306,v,value,on_change))
);
...
var vec__30309 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30309,(0),null);
var id = cljs.core.nth.call(null,vec__30309,(1),null);
var class$ = cljs.core.nth.call(null,vec__30309,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30313 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30313 == null)){
} else {
var key_30314 = temp__4661__auto___30313;
(jsprops["key"] = key_30314);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30315 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30315["name"] = c);
...
var len__29492__auto___30320 = arguments.length;
var i__29493__auto___30321 = (0);
while(true){
if((i__29493__auto___30321 < len__29492__auto___30320)){
args__29499__auto__.push((arguments[i__29493__auto___30321]));

var G__30322 = (i__29493__auto___30321 + (1));
i__29493__auto___30321 = G__30322;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__29500__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30318){
var G__30319 = cljs.core.first.call(null,seq30318);
var seq30318__$1 = cljs.core.next.call(null,seq30318);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30319,seq30318__$1);
});
...
break;
default:
var G__30325 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30325;
continue;
...
var n__29268__auto___30327 = a.length;
var i_30328 = (0);
while(true){
if((i_30328 < n__29268__auto___30327)){
(a[i_30328] = reagent.impl.template.as_element.call(null,(a[i_30328])));

var G__30329 = (i_30328 + (1));
i_30328 = G__30329;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29268__auto___30330 = a.length;
var i_30331 = (0);
while(true){
if((i_30331 < n__29268__auto___30330)){
var val_30332 = (a[i_30331]);
if((cljs.core.vector_QMARK_.call(null,val_30332)) && ((reagent.impl.template.key_from_vec.call(null,val_30332) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30331] = reagent.impl.template.as_element.call(null,val_30332));

var G__30333 = (i_30331 + (1));
i_30331 = G__30333;
continue;
} else {
}
...
var ctx = ({});
var vec__30334 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30334,(0),null);
var derefed = cljs.core.nth.call(null,vec__30334,(1),null);
...
var G__30337 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30337) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30337){
...
//# sourceMappingURL=template.js.map?rel=1544388299631
