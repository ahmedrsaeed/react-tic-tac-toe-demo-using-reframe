...
var or__28323__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj35201 = {"detail":data};
return obj35201;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28311__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28311__auto__)){
var and__28311__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__35208 = cljs.core._EQ_;
var expr__35209 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35208.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35209))){
return ((function (pred__35208,expr__35209){
return (function (p1__35202_SHARP_){
return console.warn(p1__35202_SHARP_);
});
;})(pred__35208,expr__35209))
} else {
if(cljs.core.truth_(pred__35208.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35209))){
return ((function (pred__35208,expr__35209){
return (function (p1__35203_SHARP_){
return console.debug(p1__35203_SHARP_);
});
;})(pred__35208,expr__35209))
} else {
if(cljs.core.truth_(pred__35208.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35209))){
return ((function (pred__35208,expr__35209){
return (function (p1__35204_SHARP_){
return console.error(p1__35204_SHARP_);
});
;})(pred__35208,expr__35209))
} else {
return ((function (pred__35208,expr__35209){
return (function (p1__35205_SHARP_){
return console.log(p1__35205_SHARP_);
});
;})(pred__35208,expr__35209))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35212){
...
var opts = map__35213__$1;
var eval_fn = cljs.core.get.call(null,map__35213__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35215_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35217,(0),null);
var v = cljs.core.nth.call(null,vec__35217,(1),null);
...
if(cljs.core.truth_((function (){var and__28311__auto__ = typeof localStorage !== 'undefined';
...
}catch (e35222){if((e35222 instanceof Error)){
var e = e35222;
return not_found;
} else {
throw e35222;
...
//# sourceMappingURL=utils.js.map?rel=1544388305266
