...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__30448 = cljs.core.instance_QMARK_;
var expr__30449 = reactive_val;
if(cljs.core.truth_(pred__30448.call(null,reagent.ratom.RAtom,expr__30449))){
return "ra";
} else {
if(cljs.core.truth_(pred__30448.call(null,reagent.ratom.RCursor,expr__30449))){
return "rc";
} else {
if(cljs.core.truth_(pred__30448.call(null,reagent.ratom.Reaction,expr__30449))){
return "rx";
} else {
if(cljs.core.truth_(pred__30448.call(null,reagent.ratom.Track,expr__30449))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1544388300005
